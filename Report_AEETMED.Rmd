...
```{r echo=FALSE, warning=FALSE, dpi =150}
...
```{r, echo=FALSE, include =FALSE, dpi=150}
...
```{r,  echo=FALSE, eval = FALSE, include =FALSE, dpi=150}
## Most retweeted
...
```{r word-cloud, echo=FALSE, message=FALSE, dpi=150}
library(wordcloud)
...
```
 Parece que efectivamente, en Sevilla hubo "grandes charlas" ;-), pero se voislumbra por aquí algunos de los temas estrella que ya ha definido F. Rodríguez en el blog de Journal of Ecology: sequía, fuego, y especies.
