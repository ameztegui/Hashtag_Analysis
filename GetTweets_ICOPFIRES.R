...
tweets <- searchTwitter("#ICOPFIRES", n = 5000, 
                        since="2017-01-27", until="2017-02-05")
#saveRDS(tweets, "./data/ICOPFIRES_raw_tweets.rds")

dt_tweets <- twListToDF(tweets)

saveRDS(dt_tweets, file = "./data/ICOPFIRES_df_tweets.rds")
write_csv(dt_tweets, path = "./data/ICOPFIRES_df_tweets.csv")
